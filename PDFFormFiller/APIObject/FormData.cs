...
namespace PDFFormFiller.APIObject
{
    public partial class FormData
    {
        ...
        public string does_position_appear_on_GTO_yes = "On";

        [Description("EMP5624_E[0].Page1[0].No_business[0]")]
        public string does_position_appear_on_GTO_no = "Off";

        [Description("EMP5624_E[0].Page1[0].Yes_inn[0]")]
        public string are_referred_toGTO_yes = "On";

        [Description("EMP5624_E[0].Page1[0].No_inn[0]")]
        public string are_referred_toGTO_no = "Off";
        ...
        public string ref_partner_pref_lang_talk = "On";

        [Description("EMP5624_E[0].Page1[0].rb_language_written[0]")]
        public string ref_partner_pref_lang_write = "On";
        ...
        public string alt_ref_partner_pref_lang_talk = "On";

        [Description("EMP5624_E[0].Page1[0].rb_language_written2[0]")]
        public string alt_ref_partner_pref_lang_write_ = "On";
        ...
        public string emp_CRAP_deduct_acc_no_1st_part = "40128539";
        ...
        public string business_legal_name = "adgffgf asgdfs";

        [Description("EMP5624_E[0].Page2[0].txtF_Mail_Adress1[0]")]
        public string business_address_line_1 = "hghghdgfdgfkjhdfgjk";
        ...
        public string business_website = "www.hellomoto.com";
        ...
        public string business_type_sole_prop = "Off";

        [Description("EMP5624_E[0].Page2[0].cb_partnership[0]")]
        public string business_type_partnership = "On";

        [Description("EMP5624_E[0].Page2[0].cb_society[0]")]
        public string business_type_corporation = "Off";

        [Description("EMP5624_E[0].Page2[0].cb_sole_propietor[0]")]
        public string business_type_co_operative = "Off";

        [Description("EMP5624_E[0].Page2[0].cb_not_profit[0]")]
        public string business_type_non_profit = "Off";

        [Description("EMP5624_E[0].Page2[0].cb_registred[0]")]
        public string business_type_registered_charity { get; set; }

        [Description("EMP5624_E[0].Page2[0].txtF_amout_employees[0]")]
        public string business_no_of_employees = "500";
        ...
        public string does_business_receive_support_through_ESDCWSP = "1";
        ...
        public string principal_emp_pref_lang_oral = "1";

        [Description("EMP5624_E[0].Page2[0].rb_language_written2[0]")]
        public string principal_emp_pref_lang_written = "0";
        ...
        public string alt_emp_pref_lang_oral = "0";

        [Description("EMP5624_E[0].Page2[0].rb_other_anguage_written2[0]")]
        public string alt_emp_pref_lang_written = "1";

        [Description("EMP5624_E[0].Page2[0].rb_tiers[0]")]
        public string are_you_appointing_3rd_party_complete_form { get; set; }
        ...
        public string third_party_bus_contact_pref_lang_oral { get; set; }

        [Description("EMP5624_E[0].Page3[0].rb_other_anguage_written2[0]")]
        public string third_party_bus_contact_pref_lang_written { get; set; }
        ...
        public string is_3rd_party_paid_by_employer_to_represent { get; set; }
        [Description("EMP5624_E[0].Page3[0].cb_CCRC[0]")]
        public string is_3rd_party_a_CRCC_member { get; set; }
        ...
        public string is_third_party_member_law_society { get; set; }
        ...
        public string is_third_party_member_CDNDQ { get; set; }
        ...
        public string is_third_party_member_other_paid { get; set; }
        ...
        public string is_third_party_family_or_friend { get; set; }
        [Description("EMP5624_E[0].Page3[0].cb_org_member[0]")]
        public string is_third_party_member_of_NGO_or_religious_org { get; set; }
        [Description("EMP5624_E[0].Page3[0].cb_rules_member[0]")]
        public string is_third_party_ICCRC_good_reputation { get; set; }
        [Description("EMP5624_E[0].Page3[0].cb_other_member[0]")]
        public string is_third_party_member_other_free { get; set; }
        ...
        public string expected_employment_duration_days { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_english1[1]")]
        public string expected_employment_duration_weeks { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_english1[2]")]
        public string expected_employment_duration_months { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_english1[3]")]
        public string expected_employment_duration_years { get; set; }
        ...
        public string is_job_positiion_part_of_a_uniion { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_OrallyIn[0]")]
        public string is_oral_communication_required { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_english1[4]")]
        public string oral_eng_ability { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_French1[0]")]
        public string oral_fr_ability { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_English_French1[0]")]
        public string oral_eng_and_fr_ability { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_TheOffer[0]")]
        public string is_written_communication_required { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_english2[0]")]
        public string eng_writing_ability { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_french2[0]")]
        public string fr_writing_ability { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_English_French2[0]")]
        public string eng_and_fr_writing_ability { get; set; }
        [Description("EMP5624_E[0].Page4[0].chkB_TheOffer2[0]")]
        public string is_specific_lang_communication_not_req { get; set; }
        ...
        public string is_lang_required_other_than_eng_and_fr { get; set; }
        ...
        public string have_you_tried_to_recruit_canada_residents_yes { get; set; }
        ...
        public string have_you_tried_to_recruit_canada_residents_no { get; set; }
        ...
        public string have_employees_been_laid_off_in_position { get; set; }
        ...
        public string will_hiring_TFW_affect_canadian_residents_negatively { get; set; }
        ...
        public string there_are_currently_no_employees_working_at_this_position { get; set; }
        [Description("EMP5624_E[0].Page5[0].rb_hours[0]")]
        public string is_job_offer_for_full_time_employment { get; set; }
        ...
        public string is_wage_converted { get; set; }
        ...
        public string job_benefit_disability_insurance = "On";
        [Description("EMP5624_E[0].Page5[0].chkB_DentalInsurance[0]")]
        public string job_benefit_dental_insurance { get; set; }
        [Description("EMP5624_E[0].Page5[0].chkB_Pension[0]")]
        public string job_benefit_pension { get; set; }
        [Description("EMP5624_E[0].Page5[0].chkB_ExtendedMed[0]")]
        public string job_benefit_extended_medical_insurance { get; set; }
        ...
        public string is_there_labour_dispute_at_any_location { get; set; }
        ...
        public string does_org_have_active_LMBP { get; set; }
        ...
        public string worker_1_immigration_status_if_in_canada_TFW { get; set; }
        [Description("EMP5624_E[0].Page12[0].student[0]")]
        public string worker_1_immigration_status_if_in_canada_student { get; set; }
        [Description("EMP5624_E[0].Page12[0].visitor[0]")]
        public string worker_1_immigration_status_if_in_canada_visitor { get; set; }
        [Description("EMP5624_E[0].Page12[0].refugie_demandeur[0]")]
        public string worker_1_immigration_status_if_in_canada_refugee { get; set; }
        ...
        public string worker_2_immigration_status_if_in_canada_TFW { get; set; }
        [Description("EMP5624_E[0].Page12[0].student2[0]")]
        public string worker_2_immigration_status_if_in_canada_student { get; set; }
        [Description("EMP5624_E[0].Page12[0].visitor2[0]")]
        public string worker_2_immigration_status_if_in_canada_visitor { get; set; }
        [Description("EMP5624_E[0].Page12[0].refugie_demandeur2[0]")]
        public string worker_2_immigration_status_if_in_canada_refugee { get; set; }
        ...
        public string worker_3_immigration_status_if_in_canada_TFW { get; set; }
        [Description("EMP5624_E[0].Page12[0].student3[0]")]
        public string worker_3_immigration_status_if_in_canada_student { get; set; }
        [Description("EMP5624_E[0].Page12[0].visitor3[0]")]
        public string worker_3_immigration_status_if_in_canada_visitor { get; set; }
        [Description("EMP5624_E[0].Page12[0].refugie_demandeur3[0]")]
        public string worker_3_immigration_status_if_in_canada_refugee { get; set; }
        ...
        public string worker_4_immigration_status_if_in_canada_TFW { get; set; }
        [Description("EMP5624_E[0].Page13[0].student4[0]")]
        public string worker_4_immigration_status_if_in_canada_student { get; set; }
        [Description("EMP5624_E[0].Page13[0].visitor4[0]")]
        public string worker_4_immigration_status_if_in_canada_visitor { get; set; }
        [Description("EMP5624_E[0].Page13[0].refugie_demandeur4[0]")]
        public string worker_4_immigration_status_if_in_canada_refugee { get; set; }
        ...
        public string worker_5_immigration_status_if_in_canada_TFW { get; set; }
        [Description("EMP5624_E[0].Page13[0].student5[0]")]
        public string worker_5_immigration_status_if_in_canada_student { get; set; }
        [Description("EMP5624_E[0].Page13[0].visitor5[0]")]
        public string worker_5_immigration_status_if_in_canada_visitor { get; set; }
        [Description("EMP5624_E[0].Page13[0].refugie_demandeur5[0]")]
        public string worker_5_immigration_status_if_in_canada_refugee { get; set; }
    }
}
